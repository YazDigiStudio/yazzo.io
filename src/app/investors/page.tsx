    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Pre-seed round.</h2>
      ...
      <section className="bg-gradient-to-br from-yazzo-600 to-yazzo-900 py-20 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/75 text-lg mb-10">
            We're validating the model in Helsinki. Get in touch for materials or a meeting.
          </p>
